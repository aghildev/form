...
const requiredFields = ['Deal Name', 'country', 'Donation Cause', 'Date Of Donation', 'amount', 'Currency', 'Payment Methods', 'Deal Frequency'];
...
const DealForm = () => {
    ...
    return (
        <div className={styles.formContainer}>
            <h1 className={styles.formHeading}>Deal Form</h1>
